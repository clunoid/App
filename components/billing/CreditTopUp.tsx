...
/**
 * Buy extra credits (one-time, custom amount, $5+) and configure auto-reload.
 * Credits are added securely by the Polar webhook; auto-reload charges the saved
 * card off-session when the balance drops below the chosen threshold.
 */
export function CreditTopUp() {
  ...
  return (
    <div id="credits" className="mx-auto mt-6 w-full max-w-5xl px-5 pb-12">
