...
/**
 * Stock index bot — this bot's page.
 *
...
import { INDEX_PROFILES, type IndexProfile } from "@/lib/deriv/mt5/indices";
      ...
      <div className="relative z-10 w-full px-6 py-5 sm:px-10 lg:px-16">
        ...
        <div className="mt-2 max-w-2xl">
          ...
          <p className="mt-1.5 text-[13.5px] leading-relaxed" style={{ color: TC.muted }}>
            A stock index Expert Advisor covering Swiss 20 and Wall Street 30, running on your own MetaTrader 5 terminal. One chart runs both.
          </p>
        </div>
        ...
        <Section n={1} title="Get it running">
          <div className="rounded-2xl border p-5" style={{ borderColor: TC.line, background: TC.panel }}>
            <div className="flex flex-wrap items-center gap-3">
              <Mt5Download botId="indices" botName="Stock Index" accent={ACCENT} label="Download Indices EA" />
              <span className="text-[11.5px]" style={{ color: TC.faint }}>Add more indices any time with the InpSymbols input.</span>
            </div>
