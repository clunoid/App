 ...
 *
 * The only sound is the REFEREE WHISTLE before each kick. (Synthesized crowd
 * reactions were tried and removed — filtered noise reads as static hiss, not a
 * real stadium; a convincing crowd needs an actual recording, not Web Audio.)
 * The whistle is fully synthesized: a dual detuned square tone with an
 * amplitude-modulated "pea roll", a short blast then a longer one, through a
 * master compressor so it never clips the stream.
 */
